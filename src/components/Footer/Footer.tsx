      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.links}>
            ...
            <Link href="/express" className={styles.link}>Экспресс-доставка</Link>
            <Link href="/international" className={styles.link}>Международная доставка</Link>
            <Link href="/cargo" className={styles.link}>Грузоперевозки</Link>
            <Link href="/storage" className={styles.link}>Складское хранение</Link>
          </div>
